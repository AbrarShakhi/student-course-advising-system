...
def init_admin(app, db):
    admin = Admin(app, name='Student Course Advising System', template_mode='bootstrap4')
    
    # Import models
    from app.models.students import Student, StudentImage, StudentLogin, StudentOTP
    from app.models.courses import Course
    from app.models.base import CreditPart, Room, season, Timeslot, University, Year, Department
